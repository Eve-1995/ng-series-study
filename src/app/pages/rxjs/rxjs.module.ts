...
import { AppMarkdownModule } from 'src/app/libs/markdown/markdown.module';
import { Operators01Component } from './operators/components/operators-01.component';

const COMPONENTS_DECLARATIONS = [
  InitRxjsComponent,
  OperatorsComponent,
  RxjsChild01Component,
  RxjsChild02Component,
  RxjsChild03Component,
  Operators01Component
];
const DIRECTIVE_DECLARATIONS = [];
const COMPONENTS_ENTRY = [];
@NgModule({
  imports: [SharedModule, RxjsRoutingModule, AppMarkdownModule, ContentFillModule],
